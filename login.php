...
<html class="no-js" lang="en" dir="ltr">
  ...
  <form method="post" action="login.php">
    ...
    <div class="grid-x grid-padding-x">
      <button type="submit" class="button hollow expanded" name="login_user" onclick="return confirm('Successfully Login')">Login</button>
    </div>
    <!--End Form -->
    ...
    <div class="input-group">
      <button onclick="return confirm('Successfully Login')" type="submit" class="button hollow expanded" name="login_user">Login</button>
    </div>
     end -->
  </form><br><br>
